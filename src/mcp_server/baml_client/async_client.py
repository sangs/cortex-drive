...
class BamlAsyncClient:
    ...
    async def ExtractGraph(self, transcript: str,episode_title: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractGraph", args={
...
class BamlStreamClient:
    ...
    def ExtractGraph(self, transcript: str,episode_title: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.GraphExtraction, types.GraphExtraction]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractGraph", args={
            "transcript": transcript,"episode_title": episode_title,
        })
        return baml_py.BamlStream[stream_types.GraphExtraction, types.GraphExtraction](
          __result__,
