...
class BamlSyncClient:
    ...
    def ExtractGraph(self, transcript: str,episode_title: str,
        ...
        if 'on_tick' in baml_options:
            __stream__ = self.stream.ExtractGraph(transcript=transcript,episode_title=episode_title,
                baml_options=baml_options)
            return __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractGraph", args={
    ...
    def ExtractProject(self, projectContent: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractProject", args={
    ...
    def ExtractWebPage(self, content: str,url: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractWebPage", args={
...
class BamlStreamClient:
    ...
    def ExtractGraph(self, transcript: str,episode_title: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractGraph", args={
            "transcript": transcript,"episode_title": episode_title,
        })
        return baml_py.BamlSyncStream[stream_types.GraphExtraction, types.GraphExtraction](
          __result__,
          lambda x: typing.cast(stream_types.GraphExtraction, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.GraphExtraction, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
    def ExtractProject(self, projectContent: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Project, types.Project]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractProject", args={
            "projectContent": projectContent,
        })
        return baml_py.BamlSyncStream[stream_types.Project, types.Project](
          __result__,
    ...
    def ExtractWebPage(self, content: str,url: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.WebPageExtraction, types.WebPageExtraction]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractWebPage", args={
            "content": content,"url": url,
        })
        return baml_py.BamlSyncStream[stream_types.WebPageExtraction, types.WebPageExtraction](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractGraph(self, transcript: str,episode_title: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractGraph", args={
            "transcript": transcript,"episode_title": episode_title,
        }, mode="request")
        return __result__
    def ExtractProject(self, projectContent: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractProject", args={
            "projectContent": projectContent,
        }, mode="request")
        return __result__
    def ExtractWebPage(self, content: str,url: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractWebPage", args={
            "content": content,"url": url,
        }, mode="request")
        return __result__
